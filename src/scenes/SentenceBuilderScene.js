...
export default class SentenceBuilderScene extends Phaser.Scene {
  ...
  create() {
    ...
    // ── Instruction ──────────────────────────────────────────────
    this.add
      .text(width / 2, 100, "Drag words to build the correct sentence", {
        fontFamily: "Arial, sans-serif",
        fontSize: "13px",
        color: "#9a7a58",
      })
    ...
    const backBtn = this.add
      .rectangle(44, height - 40, 80, 36, 0xddccbb)
      .setOrigin(0.5);
    this.add
    ...
    this.nextBtn = this.add
      .rectangle(width - 64, height - 40, 110, 36, 0xe07b39)
      .setOrigin(0.5)
      .setVisible(false);
    ...
    this.checkBtn = this.add
      .rectangle(width / 2, height - 40, 130, 36, 0x27ae60)
      .setOrigin(0.5);
    this.checkBtnText = this.add
      .text(width / 2, height - 40, "✔  Check", {
        fontFamily: "Arial, sans-serif",
        fontSize: "15px",
        color: "#ffffff",
        fontStyle: "bold",
  ...
  loadSentence() {
    ...
    this.progressText.setText(
      `Sentence ${this.sentenceIndex + 1} of ${this.sentences.length}`,
    );
    ...
    words.forEach((word, i) => {
      ...
      const rect = this.add
        .rectangle(width / 2, y, zoneW, WORD_H, 0xffffff)
  ...
  checkAnswer() {
    ...
    if (!allFilled) {
      this.feedbackText
        .setText("⚠️  Fill all slots first!")
        .setColor("#e07b39");
      return;
    }
  ...
  showCompletion() {
    ...
    this.add
      .rectangle(width / 2, height / 2, width - 40, 380, 0xffffff, 0.95)
      .setOrigin(0.5)
      .setStrokeStyle(3, 0xe07b39);

    this.add
      .text(width / 2, height / 2 - 130, "🎓", { fontSize: "56px" })
      .setOrigin(0.5);

    this.add
      .text(width / 2, height / 2 - 60, "All Sentences Done!", {
        fontFamily: "Georgia, serif",
        fontSize: "28px",
        color: "#2d3561",
        fontStyle: "bold",
    ...
    const replayBtn = this.add
      .rectangle(width / 2, height / 2 + 145, 200, 48, 0xe07b39)
      .setOrigin(0.5);
    this.add
      .text(width / 2, height / 2 + 145, "↺ Play Again", {
        fontFamily: "Arial, sans-serif",
        fontSize: "16px",
        color: "#ffffff",
        fontStyle: "bold",
